...
export default function SearchProfileScreen() {
  ...
  // Determine if this profile belongs to the signed-in user
  useEffect(() => {
  ...
  const renderHeader = () => (
    <View>
      ...
      <View style={styles.avatarSection}>
        ...
        {isOwnProfile ? (
          <Pressable style={styles.editButton} onPress={() => router.push("/tabs/profile")}>
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingHorizontal: 16, paddingTop: 8, paddingBottom: 8, backgroundColor: "#F8F4F0",
  },
  ...
  avatarRing: {
    ...
    borderWidth: 3, borderColor: "#FF6B35", alignItems: "center", justifyContent: "center",
  },
  ...
  followButton: {
    backgroundColor: "#FF6B35", paddingHorizontal: 36, paddingVertical: 9,
    borderRadius: 24, marginTop: 12,
  },
  followButtonText: { color: "#FFF", fontSize: 14, fontWeight: "700" },
  editButton: {
    borderWidth: 1.5, borderColor: "#CCC", paddingHorizontal: 36, paddingVertical: 9,
    borderRadius: 24, marginTop: 12,
  },
  ...
  bio: {
    ...
    textAlign: "center", paddingHorizontal: 32, marginTop: 8, backgroundColor: "#F8F4F0",
  },
  statsCard: {
    flexDirection: "row", marginHorizontal: 16, marginTop: 16, paddingVertical: 14,
  ...
  tabBar: {
    ...
    borderBottomWidth: 1, borderBottomColor: "#E8E0D8", backgroundColor: "#F8F4F0",
  },
  ...
  reviewCard: {
    marginHorizontal: 16, marginTop: 10, paddingHorizontal: 16, paddingVertical: 14,
